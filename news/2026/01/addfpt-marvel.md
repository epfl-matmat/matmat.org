+++
title       = "Our publication on algorithmic differentiation for plane-wave DFT featured as MARVEL highlight"
rss         = "Our recent publication on algorithmic differentiation for plane-wave DFT is featured as a MARVEL highlight."
rss_pubdate = Date(2026, 01, 15)
type        = "outreach"
startpage   = true
+++
